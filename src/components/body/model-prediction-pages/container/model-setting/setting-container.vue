      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-form :model="configForm" label-position="top">
          <setting-container-station
              ...
              @get-new-station="(args) => {configForm.station = args}"
          />
          ...
          <el-row :gutter="15">
            <el-col :xs="getStartDateSpan()" :sm="getStartDateSpan()" :md="getStartDateSpan()" :lg="getStartDateSpan()"
                    :xl="getStartDateSpan()">
              <el-date-picker
            ...
            <el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6" align="left">
              <el-button type="primary" color="#2261ec" style="width: 90%" @click="startPrediction()">开始预测
              </el-button>
            </el-col>
          </el-row>
        </el-form>
